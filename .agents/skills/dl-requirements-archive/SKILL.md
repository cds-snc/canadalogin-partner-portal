...
Delegate to the `release-readiness` custom agent from
`.codex/agents/release-readiness.toml` when specialized delegation materially
...
Use this skill when the goal is archive follow-through. Use
