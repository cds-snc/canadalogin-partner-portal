---
name: dl-plan-feature
description: "Deliver a scoped feature with OpenSpec tasks, tests, evidence, and handoff."
---
...
- Route user-facing UI work through [$dl-ui-build-page](../dl-ui-build-page/SKILL.md) before implementation when the work affects a new page, layout, navigation, form, multi-step flow, header, footer, menu, breadcrumb, or language toggle.
...
- Builder handoff block for [.codex/agents/builder-general.toml](../../../.codex/agents/builder-general.toml) when implementation is ready or waiting only for user confirmation.
...
Receiving agent: .codex/agents/builder-general.toml
...
When this skill runs through [.codex/agents/coordinator.toml](../../../.codex/agents/coordinator.toml) in Codex, prefer direct subagent delegation to [.codex/agents/builder-general.toml](../../../.codex/agents/builder-general.toml) when the implementation handoff status is `ready` and the user has asked to continue.
