...
Delegate to the `builder-general` custom agent from
`.codex/agents/builder-general.toml` when specialized delegation materially
...
- Route implementation fixes to [.codex/agents/builder-general.toml](../../../.codex/agents/builder-general.toml), including frontend UI, GC Design System, accessibility, or bilingual content fixes. Builder General should use the relevant UI and standards skills inside the implementation loop.
