...
use_when:
  - A named or active OpenSpec change exists.
  - The user wants to keep implementing ready slices within that one change.
  - The work should continue only while tasks are local-first, scoped, and safe.
agent: Coordinator
---
...
6. Before asking the user, use
   [.github/skills/delorean-question-resolution/SKILL.md](../skills/delorean-question-resolution/SKILL.md)
