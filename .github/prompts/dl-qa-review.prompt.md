---
id: dl-qa-review
description: Review the whole scoped change across code, docs, specs, tests, standards, and evidence.
use_when:
  - A broad pre-review or final review pass is needed.
  - The user asks to review everything, review all changes, or check the branch end to end.
  - Code, docs, OpenSpec artifacts, contracts, tests, standards, and evidence need a combined alignment pass.
...
required_inputs:
  - review_scope
  - source_request_or_issue
  - changed_files_or_branch_reference
  - openspec_change_id_or_spec_reference_when_relevant
  - known_risk_areas
...
4. Use [.github/skills/delorean-review/SKILL.md](../skills/delorean-review/SKILL.md) for review posture.
5. Use [.github/skills/delorean-testing/SKILL.md](../skills/delorean-testing/SKILL.md) for verification and skipped-check assessment.
6. Use [.github/skills/review-gc-design-system-alignment/SKILL.md](../skills/review-gc-design-system-alignment/SKILL.md) when user-facing UI changed.
7. Use [.github/skills/gc-standards/SKILL.md](../skills/gc-standards/SKILL.md), STD-019, BAS-001, and targeted `gc-review-*` skills when standards or baseline findings are needed.
...
11. Use [.github/skills/delorean-evidence/SKILL.md](../skills/delorean-evidence/SKILL.md) when review evidence inputs need to be assembled into an Evidence Bundle.
