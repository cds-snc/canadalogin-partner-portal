---
id: dl-qa-commit-ready
description: Check staged changes, hook readiness, and commit-message readiness before committing.
use_when:
  - The user wants to make current work commit-ready.
  - The user asks to commit after implementation or verification.
  - A pre-commit or commit-msg hook failed and needs remediation.
...
required_inputs:
  - intended_commit_scope
  - candidate_commit_message_when_committing
  - related_issue_spec_or_traceability_reference_when_available
  - skipped_checks_when_known
produces:
  - commit_readiness_summary
  - hook_failure_remediation
  - optional_commit_result
agent: QA Support
---
