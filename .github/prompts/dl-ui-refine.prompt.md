---
id: dl-ui-refine
description: Refine or repair user-facing UI, page pattern decisions, route structure, GC Design System alignment, accessibility, bilingual behaviour, and UI evidence.
use_when:
  - A UI design, route, page, form, menu, component, accessibility issue, bilingual issue, or screenshot/evidence gap needs refinement.
  - A previous UI implementation needs to be corrected.
  - The user wants to continue the next UI task in an active change.
...
3. Use `.github/skills/delorean-ui/SKILL.md`.
