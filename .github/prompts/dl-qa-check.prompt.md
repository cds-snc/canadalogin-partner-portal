---
id: dl-qa-check
description: Run a local quality loop before review or handoff.
use_when:
  - Work is ready for local checks before review or handoff.
  - Docs, tests, specs, contracts, and evidence need an alignment pass.
...
- When evidence packaging is in scope, use [.github/skills/delorean-evidence/SKILL.md](../skills/delorean-evidence/SKILL.md) to assemble or update the Evidence Bundle from existing evidence inputs.
