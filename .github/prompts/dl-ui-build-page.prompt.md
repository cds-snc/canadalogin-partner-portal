...
use_when:
  - A new user-facing page is being planned or built.
  - A user-facing layout, navigation, form, multi-step flow, header, footer, menu, breadcrumb, or language toggle is changing.
...
common_overlays:
  ...
  - evidence_review
required_inputs:
  - issue_scenario_or_task_reference
  - page_type
  - target_stack
  - page_role_or_entry_point
  - distinct_user_goals_or_task_flows
  - selected_approved_page_pattern_if_known
  - design_notes_or_design_package_link_if_present
  - acceptance_criteria
  - home_page_or_service_home_route
  - route_map_and_primary_task_paths
  - navigation_needs
  - shared_menu_update
  - gc_design_system_component_plan
  - form_needs
...
produces:
  ...
  - implementation_plan
  - updated_shared_menu
  - route_map_and_navigation_paths
  - gc_component_mapping
  - desktop_screenshot
  - mobile_screenshot
  - design_system_checklist
  - accessibility_result
  - exception_list_if_any
agent: Coordinator
---
...
2. Use [.github/skills/select-ui-page-pattern/SKILL.md](../skills/select-ui-page-pattern/SKILL.md) to select the approved page pattern and required page shell.
...
7. Use [.github/skills/delorean-evidence/SKILL.md](../skills/delorean-evidence/SKILL.md) when UI evidence inputs need to be assembled into an Evidence Bundle.
