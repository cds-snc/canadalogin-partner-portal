---
id: dl-dev-fix-bug
description: Investigate a defect or failure and plan a traceable remediation.
use_when:
  - A defect, incident follow-up, flaky test, or operational failure needs diagnosis.
  - A fix needs traceable evidence that the problem is understood and addressed.
...
- Route implementation fixes to [.github/agents/builder-general.agent.md](../agents/builder-general.agent.md), including frontend UI, GC Design System, accessibility, or bilingual content fixes. Builder General should use the relevant UI and standards skills inside the implementation loop.
