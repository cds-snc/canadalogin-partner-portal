---
id: dl-requirements-refine
description: Refine OpenSpec specs or active changes for requirements, scenarios, slices, tasks, validation, and handoff clarity.
use_when:
  - An OpenSpec spec or active change needs cleanup before planning, implementation, verification, or archive.
  - Requirements, scenarios, proposal, design, tasks, slices, validation, lifecycle state, or next work are unclear.
  - The user asks to pick the next implementation or verification task from an active OpenSpec change.
...
common_overlays:
  ...
  - evidence_review
required_inputs:
  - openspec_spec_or_change_reference
  - source_request_or_issue
  - mode
  - refinement_goal
  - impacted_capabilities
produces:
  - refined_openspec_artifacts
  - lifecycle_state_summary
  - slice_and_task_summary
  - validation_notes
