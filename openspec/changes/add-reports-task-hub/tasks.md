...
- [ ] 4.1 Verify card and chooser accessible names, heading hierarchy, source
  order, keyboard order, visible focus, landmarks, and stable return paths.
- [ ] 4.2 Verify one-column mobile and 200-percent zoom reflow without clipped
...
- [ ] 4.5 Run frontend standards and page-shell checks and capture desktop,
...
- [ ] 5.3 Validate OpenSpec strictly and archive without `--skip-specs` after
  implementation and verification.
- [ ] 5.4 Confirm both current capability specs reflect the implemented Reports
