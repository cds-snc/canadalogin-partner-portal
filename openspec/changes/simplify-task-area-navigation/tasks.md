...
- [ ] 4.1 Verify keyboard order, visible focus, skip-to-content, unique parent
...
- [ ] 4.5 Capture representative Administration and workspace screenshots after
  implementation.
...
- [ ] 5.3 Validate the OpenSpec change, confirm modified requirements preserve
  all intended scenarios, and archive without `--skip-specs`.
- [ ] 5.4 Confirm both current capability specs reflect the implemented
