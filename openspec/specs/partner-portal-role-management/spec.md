...
## Purpose
Define the fixed four-role authorization catalog, canonical global and
workspace-scoped assignment behavior across Applications and RP
configurations, and the retirement of legacy or mutable authorization sources.
## Requirements
