...
## Purpose
Define the canonical workspace- and Application-scoped RP-configuration task
experience, including the secret-free Configuration view, draft registration
workflow, Usage and credential destinations, and authorized compatibility
redirects from retired RP-application routes.
## Requirements
