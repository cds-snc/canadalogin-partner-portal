...
## Purpose
Define the CL Admin cross-workspace dashboard anchor, focused explicit
Production-review work, and authorized RP-configuration MAU/usage discovery
without aggregate onboarding, invitation, or secret-hygiene reporting.
## Requirements
