...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-docs-update.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-docs-update.prompt.md`.
...
- Use [.codex/agents/spec-author.md](../agents/spec-author.md) when OpenSpec behavior or design readiness changes.
- Use the platform-definition prompt when the change modifies agents, skills, prompts, workflows, hooks, policy logic, or Evidence Bundle contracts.
