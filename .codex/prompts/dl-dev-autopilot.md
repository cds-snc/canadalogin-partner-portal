...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-dev-autopilot.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-dev-autopilot.prompt.md`.
...
autopilot. Use [dl-dev-active-change.md](dl-dev-active-change.md)
