...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-delivery-autopilot.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-delivery-autopilot.prompt.md`.
...
Use [dl-dev-autopilot.md](dl-dev-autopilot.md) when changes are
...
3. Resolve agent-answerable planning blockers before declaring the change
   ...
   - invoke [dl-ui-build-page.md](dl-ui-build-page.md) when a UI
     page-pattern decision is missing; when prompt routing is unavailable, use
...
4. When planning is ready, invoke
   [dl-dev-active-change.md](dl-dev-active-change.md) for one
   named change or [dl-dev-autopilot.md](dl-dev-autopilot.md) for
