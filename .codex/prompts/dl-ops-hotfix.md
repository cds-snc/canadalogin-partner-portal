...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-ops-hotfix.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-ops-hotfix.prompt.md`.
...
- Use [.codex/prompts/dl-dev-fix-bug.md](dl-dev-fix-bug.md) when root-cause diagnosis is the main work.
- Use [.codex/prompts/dl-security-review.md](dl-security-review.md) when security or privacy risk is involved.
- Route implementation fixes to [.codex/agents/builder-general.md](../agents/builder-general.md).
...
- Route verification through [.codex/agents/qa-support.md](../agents/qa-support.md) and readiness through [.codex/agents/release-readiness.md](../agents/release-readiness.md) only when release-readiness is enabled or explicitly requested.
