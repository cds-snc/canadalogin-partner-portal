...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-requirements-shape.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-requirements-shape.prompt.md`.
...
- Do not use this prompt as the normal path for creating the first active OpenSpec package from a usable brief; route that work to `dl-requirements-start`.
