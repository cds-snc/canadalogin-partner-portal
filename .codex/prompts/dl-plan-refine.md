...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-plan-refine.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-plan-refine.prompt.md`.

Recommended role: [Delivery Planner](../agents/delivery-planner.md). When Codex subagent tooling is available, invoke that role with this prompt. If it is unavailable, read the role file and follow this prompt in the current session.
