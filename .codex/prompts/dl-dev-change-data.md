...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-dev-change-data.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-dev-change-data.prompt.md`.
...
- Use [.codex/agents/delivery-planner.md](../agents/delivery-planner.md) to produce sequencing, validation, rollback, and evidence plans.
