...
<!-- delorean-template:codex-generated from agent-configs/vscode/prompts/dl-requirements-start.prompt.md; run scripts/delorean/sync-codex-adapters.sh --write -->

Codex prompt adapter generated from `agent-configs/vscode/prompts/dl-requirements-start.prompt.md`.
