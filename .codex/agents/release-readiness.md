...
<!-- delorean-template:codex-generated from agent-configs/vscode/agents/release-readiness.agent.md; run scripts/delorean/sync-codex-adapters.sh --write -->

This Codex adapter is generated from the VS Code agent source. Edit `agent-configs/vscode/agents/release-readiness.agent.md`, then run `scripts/delorean/sync-codex-adapters.sh --write`.
