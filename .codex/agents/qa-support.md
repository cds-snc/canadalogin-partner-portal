...
<!-- delorean-template:codex-generated from agent-configs/vscode/agents/qa-support.agent.md; run scripts/delorean/sync-codex-adapters.sh --write -->

This Codex adapter is generated from the VS Code agent source. Edit `agent-configs/vscode/agents/qa-support.agent.md`, then run `scripts/delorean/sync-codex-adapters.sh --write`.
...
When Codex subagent delegation is available and defects are actionable within the
