...
<!-- delorean-template:codex-generated from agent-configs/vscode/agents/spec-author.agent.md; run scripts/delorean/sync-codex-adapters.sh --write -->

This Codex adapter is generated from the VS Code agent source. Edit `agent-configs/vscode/agents/spec-author.agent.md`, then run `scripts/delorean/sync-codex-adapters.sh --write`.
