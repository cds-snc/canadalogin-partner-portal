...
const Home: React.FC = () => {
	...
	return (
		<section>
			...
			<Text>
				You can submit a holiday for review. Before submitting an entry, please
				take a moment to view{" "}
				<Link to="/view-holidays/nationwide">all of the holidays</Link> in our
				data set. If the holiday in question is still missing after review, you
				can fill out a quick 2 page form and submit.
			</Text>
			...
			<NextHoliday
				display="homepage"
				nextHoliday={{
					date: nextFederal?.date as string,
					nameEn: nextFederal?.nameEn as string,
				}}
				federal
			/>
			...
			<NextHoliday
				display="homepage"
				nextHoliday={{
					date: nextNationwide?.date as string,
					nameEn: nextNationwide?.nameEn as string,
				}}
