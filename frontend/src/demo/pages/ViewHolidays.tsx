	...
	useEffect(() => {
		if (province) {
			...
			axios
				...
				.then(({ data }) => {
					const holidaysData =
						provinceId === "federal" ? data.holidays : data.province.holidays;
					const nextHolidayData =
						provinceId === "federal"
							? data.nextHoliday
							: data.province.nextHoliday;
			...
			<table className="mb-450">
				<thead>
					<tr className="text-left bb-sm b-default">
						<th className="py-225 font-h4">Day</th>
						<th className="py-225 font-h4">Holiday</th>
					</tr>
				</thead>
				<tbody>
			...
			{provinceId === "federal" ? (
				<Details detailsTitle="What are federal holidays?" open>
					<Text marginBottom="0">
						...
						<a className="link-default" href="/federal-and-provincial-holidays">
				...
				<Details detailsTitle="What are optional holidays?" open>
					<Text marginBottom="0">
						...
						Businesses may choose to opt-in to optional holidays but they don't
						have to. Find out more about{" "}
						<a className="link-default" href="/optional-holidays">
							optional holidays
						</a>
						.
					</Text>
