...
export const useApplicationInformationManagement =
	(): ApplicationInformationManagementState => {
		...
		const deleteMutation = useMutation({
			mutationFn: ({
				...
				removeApplicationInformation(workspaceUuid, applicationInformationUuid),
