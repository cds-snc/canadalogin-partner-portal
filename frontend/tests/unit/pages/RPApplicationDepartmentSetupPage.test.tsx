...
import { RPApplicationDepartmentSetupPage } from "@/features/rp-applications/pages/RPApplicationDepartmentSetupPage";
...
describe("RPApplicationDepartmentSetupPage", () => {
	beforeAll(() => {
	...
	it("shows application name from preflight after load", async () => {
		...
		render(<RPApplicationDepartmentSetupPage />);
