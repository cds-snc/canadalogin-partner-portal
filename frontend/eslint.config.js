...
const patchedReactPlugin = fixupPluginRules(eslintPluginReact);
...
const patchedReactJsxRuntimeConfig = {
	...patchedReactPlugin.configs.flat["jsx-runtime"],
	plugins: {
		...patchedReactPlugin.configs.flat["jsx-runtime"].plugins,
...
const reactConfig = {
	name: "react",
	extends: [patchedReactJsxRuntimeConfig],
	plugins: {
