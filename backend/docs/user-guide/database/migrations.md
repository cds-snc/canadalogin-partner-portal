...
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Add user profile fields"
```
...
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic upgrade +2

# Apply to specific revision
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic upgrade abc123def456
```
...
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic current

# Show migration history
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic history

# Show pending migrations
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic show head
```
...
```bash
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Add category model"
```
...
```bash
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Add category_id to posts"
```
...
# 2. Generate migration
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Descriptive message"
...
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic downgrade -1
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic upgrade head
```
...
```bash
# Good
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Add user email verification fields"

# Bad
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Update user model"
```
