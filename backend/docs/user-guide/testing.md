...
from src.app.repositories.crud_posts import crud_posts
...
# Or run raw uv commands inside backend/
cd backend
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest

# Run specific test categories
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -m unit
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -m integration
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -m api

# Run tests with coverage
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest --cov=src --cov-report=html

# Run tests in parallel
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -n auto

# Run specific test file
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest tests/test_api_users.py

# Run with verbose output
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -v

# Run tests matching pattern
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -k "test_user"

# Run tests and stop on first failure
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -x

# Run slow tests
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -m slow
```
...
ENVIRONMENT=testing UV_PROJECT_ENVIRONMENT=../.venv uv run pytest

# Run tests with debug output
UV_PROJECT_ENVIRONMENT=../.venv uv run pytest -s --log-cli-level=DEBUG
```
