...
Create `src/app/repositories/crud_items.py`:
...
```python
from app.repositories.crud_items import crud_items
...
cd src
UV_PROJECT_ENVIRONMENT=../../.venv uv run alembic revision --autogenerate -m "Add items table"
